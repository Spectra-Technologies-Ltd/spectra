...
export default function Page() {
  ...
  return (
    <main className="spectra-shell">
      ...
      <section id="architecture" className="capabilities-section"><div className="section-kicker"><span>04</span><span>THE ARCHITECTURE</span></div><div className="capabilities-layout"><div className="capability-sticky"><Reveal><p className="eyebrow"><span className="brand-name">BastionOS</span> · <span className="brand-name">Napoleon</span> · ONE FOUNDATION</p><h2>One system.<br /><em>Three layers.</em></h2><p className="body-copy">Three layers, one system. The infrastructure layer unifies operational data — personnel, sites, patrols and incidents. The intelligence layer learns from that data, predicts outcomes and recommends action. The application layer organizes the work and puts intelligence to use. Each layer feeds the next — infrastructure powers intelligence, intelligence powers action.</p></Reveal></div><div className="capability-stage"><div className="capability-animation-wrap"><IsometricPlatform /></div></div></div></section>
