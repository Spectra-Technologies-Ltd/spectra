...
export default function Page() {
  ...
  return (
    <main className="spectra-shell">
      ...
      <section id="architecture" className="capabilities-section"><div className="section-kicker"><span>04</span><span>THE ARCHITECTURE</span></div><div className="capabilities-layout"><div className="capability-sticky"><Reveal><p className="eyebrow"><span className="brand-name">BastionOS</span> · <span className="brand-name">Napoleon</span> · ONE FOUNDATION</p><h2>One system.<br /><em>Three layers.</em></h2><p className="body-copy">BastionOS is the operating foundation — it organizes personnel, clients, sites, assets and incidents into one real-time system. Napoleon is the intelligence layer — it learns from that data, predicts outcomes and recommends action. Infrastructure, intelligence, data and applications, engineered as a single architecture.</p></Reveal></div><div className="capability-stage"><div className="capability-animation-wrap"><IsometricPlatform /></div></div></div></section>
