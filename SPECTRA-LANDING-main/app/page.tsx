...
export default function Page() {
  ...
  return (
    <main className="spectra-shell">
      ...
      <section id="company-team" className="team-section"><div className="section-kicker"><span>05</span><span>SPECTRA WORKSHOP</span></div><div className="team-grid"><div><Reveal><p className="eyebrow">CONCEPTUALIZE · BUILD · DEPLOY</p><PrintText tag="h2" lines={[{ text: 'Work from' }, { text: 'one workspace.', style: 'em' }]} /><p className="body-copy">Spectra Workshop — a workspace for conceptualizing and building intelligent systems. Design ontologies, create Napoleon-powered agents, connect data, and deploy prototypes.</p><a className="text-button" href="/workspace">Explore the Workshop <ArrowUpRight size={17} /></a></Reveal></div><img src="/images/spectra-operator.png" alt="The Spectra Workplace operations view" /></div></section>
