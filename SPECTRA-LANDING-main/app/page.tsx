...
export default function Page() {
  ...
  return (
    <main className="spectra-shell">
      ...
      <section id="napoleon" className="command-section"><div className="section-kicker"><span>04</span><span>NAPOLEON</span></div><div className="command-layout"><div className="command-copy"><Reveal><p className="eyebrow">MACHINE INTELLIGENCE LAYER</p><h2>Signals in.<br /><em>Intelligence out.</em></h2><p className="body-copy">Napoleon is the intelligence layer of the Spectra platform. It learns from the operational data your teams already produce — attendance, patrols, incidents, sensors — to surface patterns, predict outcomes, and recommend the next action.</p></Reveal></div><div className="command-visual"><Reveal delay={120}><div className="signal-flow"><div className="signal-step"><span className="signal-idx">01</span><div><p className="signal-title">Learn</p><p className="signal-sub">Reads the data your operation already produces.</p></div></div><div className="signal-step"><span className="signal-idx">02</span><div><p className="signal-title">Predict</p><p className="signal-sub">Surfaces patterns and flags what happens next.</p></div></div><div className="signal-step"><span className="signal-idx">03</span><div><p className="signal-title">Decide</p><p className="signal-sub">Recommends the action worth taking.</p></div></div></div></Reveal></div></div></section>
